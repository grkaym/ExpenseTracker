...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./home/grk/ExpenseTracker/public/storage' => 'string',
...
'filesystems.disks.s3.endpoint','filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./home/grk/ExpenseTracker/public/storage',
...
'sanctum.csrf-cookie','demo.login','demo.logout',
'dashboard','transactions.index','transactions.create','transactions.store','profile.edit',
...
'validation.attributes.date','validation.attributes.category','validation.attributes.type','validation.attributes.amount','validation.attributes.note',);
